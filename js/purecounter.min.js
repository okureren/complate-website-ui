        ...
        (r = [
              ...
              for (
                ...
                r[a.toLowerCase()] =
                  "duration" == a.toLowerCase()
                    ? parseInt(1e3 * this.castDataType(t[n].value))
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return (
                (r = t.currency ? this.convertToCurrencySystem(e, t) : r),
            ...
            value: function (e, t) {
              ...
              return (
                ...
                (Math.abs(Number(e)) >= 1e12
                  ...
                  ? (Math.abs(Number(e)) / 1e9).toFixed(n) + " B"
                  : Math.abs(Number(e)) >= 1e6
                  ? (Math.abs(Number(e)) / 1e6).toFixed(n) + " M"
                  : Math.abs(Number(e)) >= 1e3
                  ? (Math.abs(Number(e)) / 1e3).toFixed(n) + " K"
                  : Math.abs(Number(e)))
              );
            },
          },
          ...
          },
          {
            ...
            value: function (e, t) {
              return t.separator
                ...
                : e.toString().replace(new RegExp(/,/gi, "gi"), "");
            },
          },
          {
            key: "elementIsInView",
